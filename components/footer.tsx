      ...
      <div className="container-custom py-16 lg:py-20">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 mb-12">
          ...
          <div className="lg:col-span-4">
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <h3 className="text-2xl font-bold text-neutral-900 mb-4">ARGILE</h3>
              <p className="text-neutral-600 mb-6 leading-relaxed">
                Designed in Belgium, hand-finished in clay. We create timeless furniture pieces in warm terracotta,
                solid oak, and linen for spaces that breathe.
              </p>
              <div className="flex space-x-4">
                {socialLinks.map((social) => (
                  <motion.a
                    key={social.name}
                    href={social.href}
                    className="w-10 h-10 bg-white rounded-full flex items-center justify-center text-neutral-600 hover:text-clay-600 hover:bg-clay-50 transition-all duration-200"
        ...
        >
          <div className="flex flex-col sm:flex-row items-center space-y-2 sm:space-y-0 sm:space-x-6 text-sm text-neutral-500 text-center">
            <p>&copy; {currentYear} ARGILE Studio. All rights reserved.</p>
