            ...
            <BlurPanel className="p-8 lg:p-12 bg-white/40 backdrop-blur-md grain-texture">
              ...
              {!isSubmitted ? (
                <form onSubmit={handleSubmit} className="space-y-4">
                  <div className="relative">
                    ...
                    <input
                      ...
                      className={`w-full pl-12 pr-4 py-4 bg-white/60 backdrop-blur-sm border rounded-full text-neutral-900 placeholder-neutral-500 focus:outline-none focus:ring-2 focus:ring-clay-600 focus:border-transparent transition-all duration-200 ${
                  ...
                  <motion.button
                    type="submit"
                    className="w-full bg-clay-600 text-white py-4 rounded-full font-medium hover:bg-clay-700 transition-all duration-200"
                ...
                >
                  ...
                  <h3 className="text-xl font-semibold text-neutral-900 mb-2">Welcome to ARGILE</h3>
