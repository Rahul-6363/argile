    ...
    <section ref={containerRef} className="relative h-screen overflow-hidden">
      ...
      >
        <Image
          ...
          alt="ARGILE Studio - Elegant interior with sage green walls and terracotta furniture overlooking surreal landscape"
          fill
        ...
        <div className="container-custom text-center text-white">
          <Reveal>
            <h1 className="text-6xl md:text-7xl lg:text-8xl xl:text-9xl font-bold leading-none tracking-tight mb-6">
              <AnimatedText text="Furniture shaped by" delay={0.5} />
              <br />
              <span className="italic font-light">
                <AnimatedText text="warmth, not trends." delay={1.1} />
              </span>
            </h1>
          </Reveal>
          ...
          <Reveal delay={0.2}>
            ...
            >
              Designed in Belgium, hand-finished in clay and oak — pieces made to live in.
            </motion.p>
          </Reveal>
        </div>
      </motion.div>
      ...
      >
        <BlurPanel className="mx-6 mb-6 px-6 py-4 bg-black/24 backdrop-blur-md border-white/20">
          <div className="flex items-center justify-center gap-6 text-white/90">
            ...
            <div className="flex items-center gap-2">
              <Rocket className="w-4 h-4 text-clay-400" />
